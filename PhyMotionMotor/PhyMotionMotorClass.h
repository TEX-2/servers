...
public:
	...
	~speedAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<PhyMotionMotor *>(dev))->read_speed(att);}
	virtual void write(Tango::DeviceImpl *dev,Tango::WAttribute &att)
		{(static_cast<PhyMotionMotor *>(dev))->write_speed(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
...
//	Command setAccel class definition
class setAccelClass : public Tango::Command
{
public:
	setAccelClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<PhyMotionMotor *>(dev))->is_setAccel_allowed(any);}
};

//	Command setDecel class definition
class setDecelClass : public Tango::Command
{
public:
	setDecelClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<PhyMotionMotor *>(dev))->is_setDecel_allowed(any);}
};

//	Command setSpeed class definition
class setSpeedClass : public Tango::Command
{
public:
	setSpeedClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<PhyMotionMotor *>(dev))->is_setSpeed_allowed(any);}
};

//	Command getMZC class definition
class getMZCClass : public Tango::Command
{
public:
	getMZCClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<PhyMotionMotor *>(dev))->is_getMZC_allowed(any);}
};

//	Command SetAbsoluteZeroCounter class definition
class SetAbsoluteZeroCounterClass : public Tango::Command
{
public:
	SetAbsoluteZeroCounterClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	SetAbsoluteZeroCounterClass(const char   *name,
				   ...
				   Tango::CmdArgType out)
	:Command(name,in,out)	{};
	~SetAbsoluteZeroCounterClass() {};
	
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<PhyMotionMotor *>(dev))->is_SetAbsoluteZeroCounter_allowed(any);}
};
